...
* `code.ipynb`: The main Jupyter Notebook containing the data preprocessing, exploratory data analysis (EDA), PCA implementation, and visualization.
...
```bash
git clone https://github.com/agatazz/PCA-in-Health-expenditure-and-economic-outcomes.git

```
2. Open code folder and `code.ipynb` in Jupyter Notebook or Google Colab.
