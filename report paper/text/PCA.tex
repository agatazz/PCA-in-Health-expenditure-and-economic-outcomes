...
\addbibresource{report paper/ref/references.bib}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.5\linewidth]{report paper/images/output1.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.5\linewidth]{report paper/images/output_2.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.5\linewidth]{report paper/images/output_3.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.5\linewidth]{report paper/images/output_14.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.5\linewidth]{report paper/images/output_17.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.5\linewidth]{report paper/images/output_6.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.5\linewidth]{report paper/images/output_10.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.5\linewidth]{report paper/images/output_7.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.5\linewidth]{report paper/images/scr6.png}
